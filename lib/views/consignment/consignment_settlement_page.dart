...
class ConsignmentSettlementPage extends StatefulWidget {
  ConsignmentSettlementPage({Key ?key}) : super(key: key);

  @override
  _ConsignmentSettlementPageState createState() => _ConsignmentSettlementPageState();
}

class _ConsignmentSettlementPageState extends State<ConsignmentSettlementPage> {
  //搜索字段
  String keyWord = '';
  String startDate = '';
  String endDate = '';
                ...
                child: ListTile(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) {
                          return ConsignmentSettlementDetail(FBillNo:this.hobby[i][0]['value']
                            // 路由参数
                          );
                        },
                      ),
