...
import 'package:fzwm_apl/views/consignment/consignment_allocation_detail.dart';
...
class ConsignmentAllocationPage extends StatefulWidget {
  ConsignmentAllocationPage({Key ?key}) : super(key: key);

  @override
  _RetrievalPageState createState() => _RetrievalPageState();
}

class _RetrievalPageState extends State<ConsignmentAllocationPage> {
  //搜索字段
  String keyWord = '';
  String startDate = '';
  String endDate = '';
  ...
  getOrderList() async {
    ...
    userMap['FilterString'] = "FRemainOutQty>0 and FBillTypeID.FNumber = 'FHTZD02_SYS'";
    var scanCode = keyWord.split(",");
    if (this._dateSelectText != "") {
      this.startDate = this._dateSelectText.substring(0, 10);
      this.endDate = this._dateSelectText.substring(26, 36);
      userMap['FilterString'] =
      "FRemainOutQty>0 and FDate>= '$startDate' and FDate <= '$endDate' and FBillTypeID.FNumber = 'FHTZD02_SYS'";
    }
    if(this.isScan){
      if (this.keyWord != '') {
        userMap['FilterString'] =
            "FBillNo like '%"+keyWord+"%' and FRemainOutQty>0 and FBillTypeID.FNumber = 'FHTZD02_SYS'";
      }
    }else{
      if (this.keyWord != '') {
        userMap['FilterString'] =
                ...
                child: ListTile(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) {
                          return ConsignmentAllocationDetail(
