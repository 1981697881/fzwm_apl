...
class ConsignmentReturnPage extends StatefulWidget {
  ConsignmentReturnPage({Key ?key}) : super(key: key);

  @override
  _ConsignmentReturnPageState createState() => _ConsignmentReturnPageState();
}

class _ConsignmentReturnPageState extends State<ConsignmentReturnPage> {
  //搜索字段
  String keyWord = '';
  String startDate = '';
  String endDate = '';
  ...
  getOrderList() async {
    ...
    userMap['FieldKeys'] =
    'FBillNo,FStockOrgId.FNumber,FStockOrgId.FName,FDate,FBillEntry_FEntryId,FMATERIALID.FNumber,FMATERIALID.FName,FMATERIALID.FSpecification,FOwnerTypeIdHead,FOwnerTypeIdHead,FUNITID.FNumber,FUNITID.FName,FJoinSettleQty,FApproveDate,FNote,FID,FSrcStockId.FName,FDestStockId.FName,FKeeperId.FName';
                ...
                child: ListTile(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) {
                          return ConsignmentReturnDetail(FBillNo:this.hobby[i][0]['value']
                            // 路由参数
                          );
                        },
                      ),
