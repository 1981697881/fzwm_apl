...
class VmiInventoryDetail extends StatefulWidget {
  ...
  VmiInventoryDetail({Key? key, @required this.FBillNo}) : super(key: key);

  @override
  _VmiInventoryDetailState createState() =>
      _VmiInventoryDetailState(FBillNo);
}

class _VmiInventoryDetailState extends State<VmiInventoryDetail> {
