...
import 'vmi_warehousing_detail.dart';

class VmiWarehousingPage extends StatefulWidget {
  VmiWarehousingPage({Key ?key}) : super(key: key);

  @override
  _VmiWarehousingPageState createState() => _VmiWarehousingPageState();
}

class _VmiWarehousingPageState extends State<VmiWarehousingPage> {
  //搜索字段
  String keyWord = '';
  String startDate = '';
  String endDate = '';
  ...
  getOrderList() async {
    ...
    if (this._dateSelectText != "") {
      ...
      "FDate>= '$startDate' and FENTRYSTATUS = 'A' and FDocumentStatus = 'C' and FDate <= '$endDate'";
    }
    if(this.isScan){
      if (this.keyWord != '') {
        userMap['FilterString'] =/*and FActlandQty>0*/
        "FBillNo like '%"+keyWord+"%' and FENTRYSTATUS = 'A' and FDocumentStatus = 'C' and FActlandQty>0";
      }
    }else{
      if (this.keyWord != '') {
        userMap['FilterString'] =/*and FActlandQty>0*/
        ...
        userMap['FilterString'] =/*and FActlandQty>0*/
        "FBillNo like '%"+keyWord+"%' and FENTRYSTATUS = 'A' and FDocumentStatus = 'C' and FDate>= '$startDate' and FDate <= '$endDate' and FActlandQty>0";
      }
    }
    this.isScan = false;
