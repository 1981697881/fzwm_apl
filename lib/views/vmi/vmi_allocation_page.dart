...
class VmiAllocationPage extends StatefulWidget {
  VmiAllocationPage({Key ?key}) : super(key: key);

  @override
  _RetrievalPageState createState() => _RetrievalPageState();
}

class _RetrievalPageState extends State<VmiAllocationPage> {
  //搜索字段
  String keyWord = '';
  String startDate = '';
  String endDate = '';
